BOT_TOKEN: str = "ODk2NDE5NzQ4OTQwNzc1NDI0.YWG18g.-Oj5NU3zsdKRPpV8fGwm6HZLfZo"
SPOTIFY_ID: str = "" #Optional Code
SPOTIFY_SECRET: str = "" #Optional Code

BOT_PREFIX = "$","@","#" #Remaing to add config to usermodified dashboard config
...
STARTUP_MESSAGE = "Starting Music Box..."
STARTUP_COMPLETE_MESSAGE = "Startup Complete"

NO_GUILD_MESSAGE = 'Error: You are not in a voice channel'
...
NOT_CONNECTED_MESSAGE = "Error: Bot is not connected to any voice channel"
...
INVALID_INVITE_MESSAGE = "Error: Invalid invitation link, Please try again!!"
...
HELP_YT_LONG = ("$p [link/video title/key words/playlist-link/spotify link]")
HELP_PING_SHORT = "I love ping pong"
...
ABSOLUTE_PATH = '' #Added variable path donot modify it

#The above code is still on progress, last modified : 12:26 PM , October 9.